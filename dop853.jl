function dop853(F::Function, y0, tspan;
    ...
    naccpt = 0
    nrejct = 0
    k1 = Array(eltype(y0), n)
    k2 = Array(eltype(y0), n)
    k3 = Array(eltype(y0), n)
    k4 = Array(eltype(y0), n)
    k5 = Array(eltype(y0), n)
    k6 = Array(eltype(y0), n)
    k7 = Array(eltype(y0), n)
    k8 = Array(eltype(y0), n)
    k9 = Array(eltype(y0), n)
    k10 = Array(eltype(y0), n)
    y = Array(eltype(y0), n)
    copy!(y, y0)
    facold = 1e-4
