...
λ1(ky::Float64, kx::Float64; vp=(0., 1.9), Δp=0., κ=1.1) = (ky*vp[1] + kx*vp[2]) -im*κ + sqrt(ε(ky, kx; Δp=Δp)*(ε(ky, kx; Δp=Δp) + 2))
λ2(ky::Float64, kx::Float64; vp=(0., 1.9), Δp=0., κ=1.1) = (ky*vp[1] + kx*vp[2]) -im*κ - sqrt(ε(ky, kx; Δp=Δp)*(ε(ky, kx; Δp=Δp) + 2))
